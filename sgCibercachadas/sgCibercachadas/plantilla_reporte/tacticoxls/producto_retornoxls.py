...
def hoja_calculo(request,data,nombre,inicio,fin,categoria):
        ...
        ws['A2']= 'Retorno de equipo con garantía'
        ...
        if(not categoria):
            ...
            for i in data:
                    ...
                    ws.cell(row=cont,column=3).value = i['idProveedor__razon_social']
                    ws.cell(row=cont,column=4).value = i['cantidad__sum']
                    cont = cont + 1
        else:
            ws['A5'] = 'Producto Retornado'
            ws['B5'] = 'Proveedor'
            ...
            for i in data:
                    ws.cell(row=cont,column=1).value = i['idProducto__nombre']
                    ws.cell(row=cont,column=2).value = i['idProveedor__razon_social']
